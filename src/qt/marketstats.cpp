...
const QString kBaseUrl3 = "http://bittrex.com/api/v1/public/getorderbook?market=BTC-CommunityCoin&type=both&depth=50";
const QString kBaseUrl4 = "https://poloniex.com/public?command=returnTicker";
const QString kBaseUrl5 = "http://www.poloniex.com/public?command=returnOrderBook&currencyPair=BTC_COMM";
const QString kBaseUrl6 = "http://bittrex.com/api/v1/public/getmarkethistory?market=BTC-CommunityCoin&count=100";
const QString kBaseUrl7 = "https://poloniex.com/public?command=returnTradeHistory&currencyPair=BTC_COMM";

QString bitcoinp = "";
double bitCommunityCoin;
double lastuG;
QString bitcoing;
QString dollarg;
int mode=1;
...
{
    QDesktopServices::openUrl(QUrl("https://www.bittrex.com/Market/Index?MarketName=BTC-CommunityCoin"));
}
...
if (what == kBaseUrl)
{
    ...
    QStringList data2 = data.split("{\"MarketName\":\"BTC-CommunityCoin\",\"High\":");
   ...
   //"BaseVolume":22.42443460,"TimeStamp":"2014-05-13T10:08:06.553","Bid":0.00000558,"Ask":0.00000559,"OpenBuyOrders":42,"OpenSellOrders":42,"PrevDay":0.00000861}
    lastu = last[0].toDouble() * bitCommunityCoin;
    lastuG = lastu;
    ...
    asku = ask[0].toDouble() * bitCommunityCoin;
    ...
    bidu = bid[0].toDouble() * bitCommunityCoin;
    ...
    volumeu = basevolume[0].toDouble() * bitCommunityCoin;
...
if (what == kBaseUrl2)
{
    ...
    bitCommunityCoin = (1 / bitcoin.toDouble());
    bitcoin = QString::number(bitCommunityCoin);
    if(bitcoin > bitcoinp)
    {
...
if (what == kBaseUrl4)
{
    ...
    QStringList data2 = data.split("\"BTC_COMM\":{\"last\":\"");
